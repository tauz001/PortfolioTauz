...
import ScrambledText from "../../reactbit/ScrambledText/ScrambledText"
const AboutSection = () => {
  return (
    <section id="about" className="section-container">
      ...
      <div className="about-content">
        <div className="about-text">
          <ScrambledText className="scrambled-text-demo" radius={100} duration={1.2} speed={0.5} scrambleChars={"01"}>
